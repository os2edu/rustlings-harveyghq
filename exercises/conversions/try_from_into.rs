...
impl TryFrom<(i16, i16, i16)> for Color {
    ...
    fn try_from(tuple: (i16, i16, i16)) -> Result<Self, Self::Error> {
        let r = u8::try_from(tuple.0).or(Err(IntoColorError::IntConversion))?;
        let g = u8::try_from(tuple.1).or(Err(IntoColorError::IntConversion))?;
        let b = u8::try_from(tuple.2).or(Err(IntoColorError::IntConversion))?;
